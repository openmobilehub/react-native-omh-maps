...
class OmhOnMarkerIWPressEvent(
    surfaceId: Int,
    viewId: Int,
    val position: OmhCoordinate
) : Event<OmhOnMarkerIWPressEvent>(surfaceId, viewId) {
    ...
    companion object : OmhBaseEventCompanion {
        override val NAME = "topInfoWindowPress"
        override val REGISTRATION_NAME = "onInfoWindowPress"
    }
}
